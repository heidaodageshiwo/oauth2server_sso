package com.sdcncsi.oauth2server;

import com.sdcncsi.oauth2server.utils.JsonUtil;
...
public class Oauth2serverApplicationTests {/*
	//端口
	final static long PORT = 8083;
	//clientId
	final static String CLIENT_ID = "client1";
	//clientSecret
	final static String CLIENT_SECRET = "client1";
	//用户名
	...
	//获取用户信息得URL
	final static String USER_INFO_URI = "http://127.0.0.1:" + PORT + "/userJwt";
	//登录地址
