...
<head>
    <meta charset="utf-8">
    <title>登录界面</title>
    <link rel="stylesheet" href="/oauth2server/css/reset.css"/>
    <link rel="stylesheet" href="/oauth2server/css/common.css"/>
    <link rel="stylesheet" href="/oauth2server/css/font-awesome.min.css"/>
</head>
<body>
    ...
    <div class="content">
        ...
        <div class="login_box">
            ...
            <div class="login_form">
                ...
                <form action="/oauth2server/authentication/form" method="post">
...
<script type="text/javascript" src="/oauth2server/js/jquery.min.js"></script>
<script type="text/javascript" src="/oauth2server/js/common.js"></script>
</body>
</html>
